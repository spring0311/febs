...
public class DeptController {
    ...
    public FebsResponse selectDeptByDeptId(@PathVariable Integer deptId){
        Dept dept1=deptService.findById(deptId);
        return new FebsResponse().success().data(dept1);
    }

    @GetMapping("list")
    public FebsResponse deptList(Dept dept){
        System.err.println("经过dept/list");
        return new FebsResponse().success().data(deptService.findDeptList(dept));
    }
