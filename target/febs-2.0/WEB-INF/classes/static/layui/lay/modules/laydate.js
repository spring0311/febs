...
;!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        t.elem = w(t.elem), t.eventElem = w(t.eventElem), t.elem[0] && (t.range === !0 && (t.range = "-"), t.format === i.date && (t.format = i[t.type]), e.format = t.format.match(new RegExp(n + "|.", "g")) || [], e.EXP_IF = "", e.EXP_SPLIT = "", w.each(e.format, function (t, a) {
            ...
            "0-10-1": "国庆",
            "0-12-25": "圣诞"
        } : {}, t.mark, t.arrs), w.each(["min", "max"], function (e, n) {
            var a = [], i = [];
        ...
        }), n && e.html('<span class=""></span>'), a
    }, T.prototype.arrs = function (e, t) {
        var n, a = this, i = a.config;
        return w.each(i.arrs, function (e, a) {
            var strs = '';
            a.forEach(function (items) {
                strs += '<span class="' + items + '"></span>'
            })
            var i = e.split("-");
            i[0] != t[0] && 0 != i[0] || i[1] != t[1] && 0 != i[1] || i[2] != t[2] || (n = strs)
        }), n && e.append( t[2] +'<div class="quan_wrpss">' + n + '</div>'), a
